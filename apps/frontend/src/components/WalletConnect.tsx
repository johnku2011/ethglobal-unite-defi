                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='text-left'>
                        ...
                        <div className='text-sm text-gray-500'>
                          Via Privy (MetaMask, WalletConnect, Coinbase)
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='text-left'>
                        ...
                        <div className='text-sm text-gray-500'>
                          Popular Sui wallet extension
                        </div>
                      </div>
                    </div>
                    <div
                      className={`text-sm ${availableWallets.suiet ? 'text-green-600' : 'text-red-600'}`}
                    >
                  ...
                  >
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='text-left'>
                        ...
                        <div className='text-sm text-gray-500'>
                          Your Sui super app (formerly Sui Wallet)
                        </div>
                      </div>
                    </div>
                    <div
                      className={`text-sm ${availableWallets.slush ? 'text-green-600' : 'text-red-600'}`}
                    >
