        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-16'>
            <div className='flex items-center'>
              <h1 className='text-2xl font-bold text-gradient'>UniPortfolio</h1>
            </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            <div className='card'>
              ...
              <p className='text-sm text-gray-500 mt-1'>
                {connectedWallets.map((w) => w.type).join(' + ') ||
                  'None connected'}
              </p>
            </div>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        <div className='font-medium text-gray-900'>
                          {wallet.type === 'ethereum' ? 'Ethereum' : 'Sui'}{' '}
                          Wallet
                        </div>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <p className='text-gray-500'>
                  View your portfolio across all chains
                </p>
              </div>
              <div className='flex items-center space-x-3'>
                <div className='w-8 h-8 bg-gray-100 text-gray-400 rounded-full flex items-center justify-center font-semibold'>
                ...
                <p className='text-gray-500'>
                  Start swapping and bridging assets
                </p>
              </div>
            </div>
          </div>
